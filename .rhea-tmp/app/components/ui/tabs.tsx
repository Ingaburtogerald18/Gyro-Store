  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        // Pestaña activa: pill LLENO con el acento de marca, igual que
        // `AnimatedTabs` (el otro sistema de tabs del panel). El default del
        // registry no se veía: en oscuro pintaba `bg-input/30`, que sobre
        // `bg-muted` es 4.5% de blanco → 1.62:1 contra su propio contenedor; en
        // claro, `bg-background` sobre `bg-muted` daba 1.11:1. Con el pill lleno
        // el borde queda en 4.8:1 (claro) y el texto en 7.2:1 sobre el acento.
        // El estado no se apoya SOLO en color: también cambia el peso (§8).
        "data-active:bg-primary data-active:font-semibold data-active:text-primary-foreground data-active:shadow-sm dark:data-active:bg-primary dark:data-active:text-primary-foreground",
