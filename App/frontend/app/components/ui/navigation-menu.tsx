...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <HugeiconsIcon icon={ArrowDown01Icon} size={12} strokeWidth={2} className="relative top-px ml-1 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180" aria-hidden="true" />
    </NavigationMenuPrimitive.Trigger>
  )
}
