-- ============================================================================
-- Gyro Store v2 · 0005 · Seed (datos de negocio + configuración)
-- ============================================================================
-- Único archivo con INSERTs. A diferencia de 0001–0004, este es IDEMPOTENTE
-- (`on conflict` / `where not exists`): el seed puede volver a correrse sobre
-- una base ya poblada sin duplicar nada ni fallar.
--
